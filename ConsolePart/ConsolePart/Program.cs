...
namespace ConsoleApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IResultSerializer jsonSerializer = new TracerLibrary.JsonSerializer();
            ...
            IResultSerializer xmlSerializer = new TracerLibrary.XmlSerializer();
